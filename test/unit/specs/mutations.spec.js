import {mutations} from 'H:\softwareDoc\GitHub\miniApp\src\vuex\store'

const {ADD_NOTE, EDIT_NOTE, DELETE_NOTE, TOGGLE_NOTE, SHWO_MARK, UPDATE_ACTIVE_NOTE} = mutations
...
describe('mutations', () => {
  ...
  it('ADD_NOTE Test', () => {
    ...
    expect(state.activeNote.txt).toEqual('Hello Note!')
